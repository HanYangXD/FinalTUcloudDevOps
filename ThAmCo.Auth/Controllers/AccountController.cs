...
using ThAmCo.Auth.Models.AccountViewModels;
//using ThAmCo.Auth.Services;
...
namespace ThAmCo.Auth.Controllers
{
    public class AccountController : Controller
    {
        ...
        public async Task<IActionResult> Logout()
        {
            ...
            return RedirectToAction(nameof(HomesController.Index), "Home");
        }
